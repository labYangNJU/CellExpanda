...
class Decoder(nn.Module):
    ...
    def forward(self, z, library, global_step=0):  
        ...
        if global_step == 133:
            print('px rate', global_step, z[6].detach().cpu().numpy(), library[6].detach().cpu().numpy(), px_rate[6][19].detach().cpu().numpy(), px_scale[6][19].detach().cpu().numpy(), px_dropout[6][19].detach().cpu().numpy())  
