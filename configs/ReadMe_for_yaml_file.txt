...
min_peaks: The minimum percentage of features that can be detected in a cell. 
Example:
0


min_cells: The minimum percentage of cells with null-zero values for each feature. 
Example:
0


max_cells: The maximum percentage of cells with null-zero values for each feature. 
Example:
1
