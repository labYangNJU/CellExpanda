...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='CellMATE,a Multi-head Adversarial Training-based Early-integration approach specifically developed for paired multiomics.')
